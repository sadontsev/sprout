...
> **Placeholders, not values.** `<YOUR_TEAM_ID>`, `<YOUR_DEVICE_UDID>`, `homeserver`/
> `homeserver.local` and `*.example.com` stand in for your own. Nothing identifying is committed:
