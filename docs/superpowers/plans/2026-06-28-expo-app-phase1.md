...
- **Phase 4 — Native push + polish:** the **push relay** (small service on <your-server>: Bambuddy webhook → Expo Push → APNs, deep-linked), notification handling in-app, and UI polish via **Claude Design / the frontend-design skill**.
